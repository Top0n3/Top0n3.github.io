...
Whith rabin2 , you can : <br>
 ...
 Those informations is very helpful To succeed in your reverse. <br> It can help you to choice which tools to use to do the reverse.
 For example, if you found that the binary is written with Go langage, you will use tools which are made for it.
...
``radare2 /bin/ls``<br>
you will get a console where you start inspecting things, disassemble function and so on <br>
```bash
$radare2 /bin/ls
...
To do that, you must specifi the -w option on radare2 commande. <br> Make sure that you have write permission on the file. see Below
<br>
...
To open the file in debug mode, use -d option. See Below
```
$radare2 -dw ./ls
