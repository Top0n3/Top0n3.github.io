...
It is used to automate  reverse engineering challenge like crackmes solving  by making symbolic execution and also to found a bug like buffer overflow through static and dynamic binary analyse (also symbolic execution)
...
<br> As angr is a python3 module. to create a project, you must import it and use it's classe ``Project``. Below is an example of angr project with /bin/ls binary
...
Below is how to create it with Angr project <br>
...
<br> Below is how to create theme:
```python
import claripy
