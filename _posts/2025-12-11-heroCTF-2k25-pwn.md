...
- Heap Heap Hooray 2:
On this version, the purspose was not to call admin function but use UAF and Heap Boof to overwrite return address of function on stack.  The exploit path is Below
```sh
